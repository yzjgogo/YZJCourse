 ...
 */
public class ZHLUploadRequest extends ZHLRequest {

    private static final String TAG = "ZHLUploadRequest";
...
//    }
    ...
    public ZHLUploadRequest(String url, Map<String, Object> param, AbsResult result) {
...
*/
    ...
    protected void initRequestParams(Map<String, Object> param) {
        ...
        rp.addHeaderParameter("scope", "com.zhl.ketang.web");
        // 设置请求参数
        for (String s : param.keySet()) {
            Object value = param.get(s);
            if (value instanceof String) {
                rp.addBodyParameter(s, (String) value);
            }
            if (value instanceof File) {
                if (((File) value).exists()) {
                    rp.addBodyParameter(s, (File) value, "application/octet-stream");
                }
            }
        }
        super.setParamsInside(rp);
        // 设置请求超时
        setRetryPolicy(new DefaultRetryPolicy(60000, 0, 1f)); // 60秒超时,不重试
    }
