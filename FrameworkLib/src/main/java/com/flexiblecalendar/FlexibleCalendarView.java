...
import com.flexiblecalendar.entity.Event;
import com.flexiblecalendar.entity.SelectedDateItem;
import com.flexiblecalendar.exception.HighValueException;
import com.flexiblecalendar.infiniteviewpager.InfinitePagerAdapter;
import com.flexiblecalendar.view.BaseCellView;
import com.flexiblecalendar.view.NoScollerGridView;
import com.flexiblecalendar.view.impl.DateCellViewImpl;
import com.flexiblecalendar.view.impl.WeekdayCellViewImpl;
...
public class FlexibleCalendarView extends LinearLayout implements
    ...
    private NoScollerGridView weekDisplayView;
    ...
    private void init(AttributeSet attrs) {
        ...
        weekDisplayView = new NoScollerGridView(context);
...
//                ViewGroup.LayoutParams.WRAP_CONTENT, 1f));
        monthViewPager.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
