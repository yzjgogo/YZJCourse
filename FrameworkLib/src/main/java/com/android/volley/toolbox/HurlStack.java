...
public class HurlStack implements HttpStack {
    ...
    private static boolean hasResponseBody(int requestMethod, int responseCode) {
        return requestMethod != Request.Method.HEAD && !(HttpStatus.SC_CONTINUE <= responseCode && responseCode < HttpStatus.SC_OK) && responseCode != HttpStatus.SC_NO_CONTENT
    ...
    /* package */ static void setConnectionParametersForRequest(HttpURLConnection connection, Request<?> request) throws IOException, AuthFailureError {
        switch (request.getMethod()) {
            case Method.DEPRECATED_GET_OR_POST:
                ...
                HttpEntity postBody = request.getBody();
                if (postBody != null) {
...
//            connection.setChunkedStreamingMode(1024 * 8);
    ...
    protected HttpURLConnection createConnection(URL url) throws IOException {
        ...
        if(MLog.DEBUG_TRUE || DebugUrl.APP_INNER){
