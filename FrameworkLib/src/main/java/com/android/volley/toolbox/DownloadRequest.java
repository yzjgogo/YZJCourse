...
public class DownloadRequest extends Request<File> {
    ...
    public DownloadRequest(String url, String fileSavePath, boolean autoResume, Response.Listener<File> listener, Response.ErrorListener errorListener) {
        this(Method.GET, url, fileSavePath, autoResume, listener, errorListener);
    }
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        // zjh 更改 下载request header 中添加token
//        if (OauthApplicationLike.getToken() != null && !TextUtils.isEmpty(OauthApplicationLike.getToken().access_token)) {
//            headers.put("Authorization", Tools.getAccessToken(OauthApplicationLike.getToken().access_token));
//        }
        return headers;
    }
     ...
     * @param priority
     * @author zjh
     * @createTime 2016-3-21 下午7:24:59
     */
