...
public abstract class Downloader {
     ...
     * TODO:modify 2014-05-25 ylf 传入config
     */
    public abstract long downloadToStream(String uri, OutputStream outputStream, final BitmapUtils.BitmapLoadTask<?> task, BitmapDisplayConfig bitmapDisplayConfig);
