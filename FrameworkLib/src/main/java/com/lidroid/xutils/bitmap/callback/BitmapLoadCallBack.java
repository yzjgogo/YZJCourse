...
public abstract class BitmapLoadCallBack<T extends View> {
    ...
    // TODO:modify ylf 05-29 增加标识是否是用户传入的回调对象
    private Boolean isCallBackByUser = false;
    private BitmapSetter<T> bitmapSetter;

    public Boolean getIsCallBackByUser() {
        return isCallBackByUser;
    }

    public void setIsCallBackByUser(Boolean isCallBackByUser) {
        this.isCallBackByUser = isCallBackByUser;
    }
