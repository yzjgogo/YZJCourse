...
public class DbUtils {
     ...
     * @throws DbException
     * @author ylf
     * @createTime 2014年5月25日 上午11:03:29
     */
    public void update(Object entity, WhereBuilder whereBuilder, List<KeyValue> keyValues) throws DbException {
        if (!tableIsExist(entity.getClass()))
            return;
        try {
            beginTransaction();

            execNonQuery(SqlInfoBuilder.buildUpdateSqlInfo(this, entity, whereBuilder, keyValues));
