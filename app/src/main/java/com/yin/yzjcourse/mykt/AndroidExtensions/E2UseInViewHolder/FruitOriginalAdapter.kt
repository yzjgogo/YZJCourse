...
class FruitOriginalAdapter(val fruitList: List<Fruit>) : androidx.recyclerview.widget.RecyclerView.Adapter<FruitOriginalAdapter.ViewHolder>() {
     ...
     */
    class ViewHolder(containerView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(containerView) {
