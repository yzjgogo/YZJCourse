...
public class DiySimpleActivity extends BaseActivity {
    ...
    R.id.bt_dispatch_view,R.id.bt_cache_view,R.id.bt_shader_sweep,R.id.bt_multi_point,R.id.bt_velocity,R.id.bt_size,R.id.bt_drawable})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_cache_view:
                ...
                break;
            case R.id.bt_size:
                startActivity(new Intent(this, ViewSizeActivity.class));
                break;
            case R.id.bt_drawable:
                startActivity(new Intent(this, DIYDrawableActivity.class));
                break;
        }
    }
}
