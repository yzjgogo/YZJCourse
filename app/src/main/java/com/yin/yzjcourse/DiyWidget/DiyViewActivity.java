...
public class DiyViewActivity extends BaseActivity {
    ...
    @OnClick({R.id.bt_matrix,R.id.bt_src_out_eraser,R.id.bt_diy,R.id.bt_canvas_change,R.id.bt_canvas_text,R.id.bt_canvas_beisaier,R.id.bt_hit_rect,R.id.bt_draw_rect,R.id.bt_local_rect,R.id.bt_bitmap})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_local_rect:
                ...
                break;
            case R.id.bt_bitmap:
                startActivity(new Intent(this, MyBitmapActivity.class));
                break;
        }
    }
}
