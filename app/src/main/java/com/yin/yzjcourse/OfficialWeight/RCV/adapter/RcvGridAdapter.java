 ...
 */
public class RcvGridAdapter extends RecyclerView.Adapter<RcvGridAdapter.ViewHolder> {
    private List<RcvBean> rcvBeanList;
    private Context mContext;

    public RcvGridAdapter(List<RcvBean> rcvBeanList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.rcv_grid_item, parent, false);
